...
public class Service implements Observable<HotelChangeEvent> {
    ...
    private Repository<Double, Client> clientRepository;
    ...
    public Service(Repository<Double, Location> locationRepository, Repository<Double, Hotel> hotelRepository, Repository<Double, SpecialOffer> specialOfferRepository, Repository<Double, Client> clientRepository, Repository<Double, Reservation> repositoryRepository) {
