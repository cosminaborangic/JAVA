...
public class ClientRepo<ID, E extends Entity<ID>> implements Repository<Double, Client> {
    private final JDBCUtils jdbcUtils = new JDBCUtils();

    @Override
    public List<Client> findOne(Double aLong, Date startDate, Date endDate) {
        return null;
    }

    public Client findEntity(Double id) {
